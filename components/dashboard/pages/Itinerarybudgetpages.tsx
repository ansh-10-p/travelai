...
const DAYS = [
  {
    ...
    activities: [
      { time: "02:15", emoji: "✈️", title: "Depart BOM",          sub: "Air India AI 131 · Terminal 2" },
      { time: "08:45", emoji: "🛬", title: "Arrive CDG",           sub: "Immigration · Baggage claim" },
      { time: "10:30", emoji: "🚇", title: "RER B → Gare du Nord", sub: "35 min · ₹280/person" },
      { time: "12:00", emoji: "🏠", title: "Check-in Airbnb",      sub: "Montmartre Studio · Host: Marie" },
      { time: "15:00", emoji: "⛪", title: "Sacré-Cœur Basilica",  sub: "Walk up · Free entry · Sunset views" },
      { time: "19:30", emoji: "🍽️", title: "Dinner: Le Relais",    sub: "Classic French · ~₹1,600/person" },
    ],
  },
  {
    day: 2, date: "Apr 12", title: "Louvre & The Seine",
    activities: [
      { time: "10:00", emoji: "🎭", title: "Louvre Museum",         sub: "Skip-the-line · GYG-774KL · 3h guided tour" },
      { time: "13:30", emoji: "☕", title: "Lunch: Café Marly",     sub: "Louvre view terrace · ~₹1,400/person" },
      { time: "15:30", emoji: "🌉", title: "Walk along the Seine",  sub: "Pont des Arts → Notre-Dame · 2h" },
      { time: "18:00", emoji: "🗺️", title: "Marais district",       sub: "Explore galleries & boutiques" },
      { time: "20:00", emoji: "🍷", title: "Wine & cheese",         sub: "Île Saint-Louis bistro · ~₹1,200" },
    ],
  },
  {
    day: 3, date: "Apr 13", title: "Versailles & Eiffel Tower",
    activities: [
      { time: "09:00", emoji: "🚆", title: "RER C to Versailles",  sub: "45 min · Château opens 9 AM" },
      { time: "09:45", emoji: "🏛️", title: "Palace of Versailles", sub: "Palace + Hall of Mirrors + Gardens" },
      { time: "14:00", emoji: "🚆", title: "Return to Paris",       sub: "RER C back" },
      { time: "16:00", emoji: "🗼", title: "Eiffel Tower summit",   sub: "Pre-booked · Golden hour views 🌅" },
      { time: "20:00", emoji: "🍽️", title: "Bistrot du 7ème",      sub: "Near Eiffel · Cozy French bistro" },
    ],
  },
];
