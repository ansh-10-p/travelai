...
export const StatCard = ({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className={`bg-white p-6 rounded-lg border border-gray-200 shadow-md cursor-pointer`}
    >
      <div className="flex items-start justify-between">
        ...
        <motion.div
          ...
          className={`p-3 rounded-lg bg-opacity-10 ${color}`}
        >
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`p-3 rounded-lg bg-opacity-10 flex-shrink-0 ${color}`}
      >
  ...
  return (
    ...
    >
      <div className="relative h-40 overflow-hidden">
        ...
        >
          <button className="px-4 py-2 bg-white text-primary font-semibold rounded-lg hover:bg-gray-100">
            View Details
          </button>
        </motion.div>
      </div>
